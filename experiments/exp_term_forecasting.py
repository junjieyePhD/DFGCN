...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            # flops, params = get_model_complexity_info(self.model, (96,137), as_strings=False, print_per_layer_stat=False)
            # flops_in_g = flops / 1e6  # 转换为 G FLOPs
            # print(f"FLOPs: {flops} 等于 {flops_in_g:.2f}M")
            # # 将参数数量转换为百万（M）
            # params_in_m = params / 1e6
            # print(f"Params: {params} 等于 {params_in_m:.3f}M")
